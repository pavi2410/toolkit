    ...
    <footer className="mt-20 border-t border-(--line) px-4 pb-14 pt-10 text-(--sea-ink-soft)">
      <div className="page-wrap flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
        <p className="m-0 text-sm">
          &copy; {year} pavi2410. All rights reserved.
        </p>
        <p className="island-kicker m-0">toolkit.pavi2410.com</p>
      </div>
      <div className="mt-4 flex justify-center gap-4">
        ...
        >
          <span className="sr-only">Follow pavi2410 on X</span>
        ...
        <a
          ...
          className="rounded-xl p-2 text-(--sea-ink-soft) transition hover:bg-(--link-bg-hover) hover:text-(--sea-ink)"
        >
          <span className="sr-only">Go to pavi2410 GitHub</span>
          <svg viewBox="0 0 16 16" aria-hidden="true" width="32" height="32">
            <path
              fill="currentColor"
